...
function xcargar()
    {
        console.log("xcargar");
        var recurso = "http://localhost:81/ejemplo-06-14/ciudades/api.php?mod=ciudades";
        fetch(recurso)
...
function clkeditar(e) {
  ...
  function clkborrar(e) {
        ...
        eid = e.target.getAttribute("data-id");
                console.log("xcargar");
        var recurso = "http://localhost:81/ejemplo-06-14/ciudades/api.php?mod=ciudades&action=borrar&id="+eid;
       console.log(recurso);
        fetch(recurso)
					.then((response) => response.json())
					.then((data) => {
...
async function guardar()
    {
        ...
        var recurso ="http://localhost:81/ejemplo-06-14/ciudades/api.php?mod=ciudades&action=guardar";
		console.log(recurso);
        var config = {
					method: "POST", // or 'PUT'
